"""
Django settings for restless_shape_47064 project.
...
ROOT_URLCONF = 'restless_shape_47064.urls'
...
WSGI_APPLICATION = 'restless_shape_47064.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_shape_47064 API",
    "DESCRIPTION": "API documentation for restless_shape_47064 App",
    "VERSION": "v1",
}
